<template>
  <div>
    <!-- footer -->
    <!-- <CryptoMarqueeWidget></CryptoMarqueeWidget> -->
    <footer class="footer">
      <div class="container">
        <div class="row">
          <div
          ...
          >
            ...
            <p class="footer__tagline">
              Play to Earn GameFi Aggregator. <br />The point of using Lorem
              Ipsum is that it has <br />a more-or-less normal distribution of
              letters.
            </p>
            ...
            <div class="footer__lang">
              ...
              <ul
                class="dropdown-menu footer__lang-dropdown"
                aria-labelledby="dropdownLang"
              >
                <li>
                  <a href="#"
                    ><img src="/img/flags/spain.svg" alt="" /><span
                      >Spanish</span
                    ></a
                  >
                </li>
                <li>
                  <a href="#"
                    ><img src="/img/flags/france.svg" alt="" /><span
                      >French</span
                    ></a
                  >
                </li>
                <li>
                  <a href="#"
                    ><img src="/img/flags/china.svg" alt="" /><span
                      >Chinese</span
                    ></a
                  >
                </li>
          ...
          >
            ...
            <div class="footer__nav">
              <RouterLink :to="{ name: 'about', hash: '#teams' }"
                >Our team</RouterLink
              >
              <RouterLink :to="{ name: 'about', hash: '#tokenomics' }"
                >Tokenomics</RouterLink
              >
              <RouterLink :to="{ name: 'about', hash: '#resources' }"
                >Resources</RouterLink
              >
              <RouterLink :to="{ name: 'about', hash: '#awards' }"
                >Awards</RouterLink
              >
            </div>
          </div>
          ...
          <div
            class="col-12 col-md-8 col-lg-6 col-xl-4 order-3 order-md-3 order-lg-1 order-xl-2"
          >
            <div class="row">
              <div class="col-12">
                <h6 class="footer__title">Features & Benefits</h6>
              </div>
              ...
              <div class="col-6">
                <div class="footer__nav">
                  ...
                  <RouterLink :to="{ name: 'traders' }">Traders</RouterLink>
                </div>
              </div>
          ...
          <div
            class="col-6 col-md-4 col-lg-3 col-xl-2 order-2 order-md-4 order-lg-3 order-xl-4"
          >
            <h6 class="footer__title">Support</h6>
            <div class="footer__nav">
              <RouterLink :to="{ name: 'home', hash: '#faq' }">Faq</RouterLink>
              <RouterLink :to="{ name: 'contact' }">Ask a question</RouterLink>
          ...
          <div class="col-12">
            <div class="footer__content">
              ...
              <small class="footer__copyright"
                >© {{ CONFIG.appName }}, {{ new Date().getFullYear() }}.</small
              >
            </div>
          </div>
        </div>
