  ...
  <section class="section section--first">
    <div class="container">
      <div class="row">
        <!-- breadcrumb -->
        <div class="col-12">
          <BreadcrumbComponent title="Contact Us"></BreadcrumbComponent>
        </div>
        <!-- end breadcrumb -->
        ...
        <div class="col-12 col-lg-5">
          ...
          <div class="contacts">
            <div class="contacts__list">
              <a :href="`mailto: ${CONFIG.email}`" class="contact">
                ...
                <span class="contact__text">{{ CONFIG.email }}</span>
              </a>

              <a :href="`tel:${CONFIG.phone}`" class="contact">
                <span class="contact__icon">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    <path
                ...
                <span class="contact__text">{{ CONFIG.phone }}</span>
              </a>
              ...
              >
                ...
                <span class="contact__text">{{ CONFIG.address }}</span>
              </a>
            </div>
        ...
        <div class="col-12 col-lg-6 offset-lg-1">
          <form class="form" action="#">
            <div class="row">
              ...
              <div class="col-12">
                <button type="button" class="form__btn form__btn--small">
                  Submit
                </button>
              </div>
            </div>
